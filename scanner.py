...
def generate_analysis(data, anthropic_key):
    ...
    prompt=('Analista tecnico momentum. Informe ejecutivo espanol directo. '+aviso+
            ...
            'IMPORTANTE: al final de cada seccion añade un parrafo breve precedido por el emoji '
            '💬 titulado "En palabras simples:" que explique lo mismo sin jerga financiera, '
            'como si se lo contaras a alguien que nunca ha invertido en bolsa. '
            'Usa analogias del dia a dia si ayudan. Maximo 2 frases por explicacion simple. '
