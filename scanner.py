...
def generate_analysis(data, anthropic_key):
    ...
    prompt = (
        ...
        'Estructura: 1.MERCADO 2.TEMAS PRIORITARIOS 3.ENTRADAS(niveles exactos) 4.EXTENDIDOS 5.CONCLUSION. La CONCLUSION debe terminar con un parrafo titulado RIESGOS DEL ESCENARIO que liste brevemente que condiciones invalidarian la tesis: perdida de MM200 por SPY, perdida de liderazgo sectorial, VIX elevado, deterioro de amplitud, resultados empresariales negativos proximos. '
        ...
        'Al final de la seccion ENTRADAS incluye una tabla comparativa con columnas: TICKER | SETUP | R/B | SCT | RIESGO | RANKING. RIESGO se calcula asi: Alto = SCT<50 O RSI>70; Medio = SCT entre 50-70 Y RSI entre 55-70; Bajo = SCT>70 Y RSI<70 Y CMF>0.1. RANKING ordena por conviccion total considerando SCT (40%), R/B (20%), fuerza sectorial (20%) y flujo CMF (20%); indica la formula brevemente bajo la tabla. '
