...
def update_setups_history(values, all_groups):
    ...
    for entrada in history[:-1]:  # todos menos hoy
        ...
        for s in entrada['setups']:
            ...
            # NUEVO (05/07) — sesiones que lleva la señal en la direccion actual, para
            # distinguir ruptura nueva (1 sesion) de persistente (>1) en informe y alertas
