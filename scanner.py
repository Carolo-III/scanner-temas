...
def actualizar_checkpoints_history(evaluaciones):
    """Lee el historico del repo, anade los checkpoints de hoy y lo devuelve para subir.
    Mismo cinturon que las demas series: si la lectura de GitHub falla se OMITE la
    actualizacion y el fichero del repo queda intacto (nunca se reescribe a ciegas)."""
...
def main():
    ...
    checkpoints_history = actualizar_checkpoints_history(evaluaciones)
